...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\Josue\flutterproj\BorgiaBackend\Borgia_backend\venv'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\Josue\flutterproj\BorgiaBackend\Borgia_backend\venv\Scripts\deactivate.nu'
